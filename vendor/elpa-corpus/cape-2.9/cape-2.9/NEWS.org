...
* Version 2.9 (2026-08-21)

- =cape-dabbrev=: Inhibit redisplay to prevent flicker.

* Version 2.8 (2026-08-01)

- =cape-dict=, =cape-dabbrev=: Down case candidates if input is all lower case.
- =cape-capf-super=: Improve =try-completion= handling.
- =cape-emoji=: Improve emoji name normalization.

* Version 2.7 (2026-05-19)
